...
function main() {
    ...
    fmt.println "Processing step 3";
    if (var_3 > 20) {
        fmt.println "Value is large";
    }
    fmt.println "Processing step 4";
    if (var_4 > 20) {
        fmt.println "Value is large";
    }
}
...
// Calculation 7
result_7 = var_7 * 2 + 5
fmt.println result_7
// Calculation 8
result_8 = var_8 * 2 + 5
fmt.println result_8
// Calculation 9
result_9 = var_9 * 2 + 5
fmt.println result_9
